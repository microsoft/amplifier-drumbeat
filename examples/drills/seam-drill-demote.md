...
automation:
  ...
  steps:
    - id: step-1
      prompt: |-
        This is a MECHANISM DRILL for the delivery seam. It is not real work.
    ...
    - id: step-2
      prompt: |-
        IMPORTANT — read this now and remember it for the final turn of this conversation.
...
Mechanism drill: the urgent-only demotion gate.
