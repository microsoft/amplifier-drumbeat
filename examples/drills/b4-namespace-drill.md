...
1. This is a MECHANISM DRILL for the namespace batch, fired manually on purpose. It is not real work, it is not about anything in your ledger, and nothing here needs judgment.
...
2. Reply with exactly this one line and nothing else — no bold, no headings, no preamble:
