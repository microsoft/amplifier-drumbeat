...
1. Load and follow guidance/MEETINGS.md, guidance/ATTENTION.md, and
   guidance/IDENTITY.md.

2. List the meetings that have already occurred today and resolve which of them
...
3. For each transcript not already recorded in your durable record — check that
...
4. Report only what needs my attention, and record each item in your durable
...
5. If this run's transcripts confirmed anything new and durable about how I or a
