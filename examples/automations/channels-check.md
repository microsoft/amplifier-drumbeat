...
1. Load and follow guidance/MESSAGING.md and guidance/ATTENTION.md.

2. Sweep every broadcast channel you have access to for activity since your last
   check in this conversation — or the last two hours if this is the first run.
   Review both the root messages and their replies.

3. Report what needs my attention from that window, using your judgement per the
...
4. This is a read-only run: do NOT mark anything read, do NOT send anything, do
...
5. This automation is `notify: urgent-only`. **Your report is always saved to
