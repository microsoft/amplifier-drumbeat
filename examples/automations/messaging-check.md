...
1. Load and follow guidance/MESSAGING.md and guidance/ATTENTION.md as written.

2. Review messaging activity **since your last check in this conversation** — not
...
3. Determine which messages can be marked read, based on guidance I have
...
4. Update guidance/MESSAGING.md with anything durable you learned this run —
