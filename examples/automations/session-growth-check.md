...
1. Report the current wall-clock time and confirm which schedule expression
...
2. Gather the measurements. **The files are the measurement; your job is the
...
3. Report what actually needs me, in descending order of what matters:
...
4. Judge whether any of this is worth interrupting me. Nothing dead, nothing
...
5. Do not rotate anything yourself, and do not delete any transcript. Dead and
