...
automation:
  ...
  steps:
    - id: load-guidance
      prompt: |-
        Load and follow guidance/EMAIL.md and guidance/ATTENTION.md as written — no
    ...
    - id: check-inbox
      prompt: |-
        Check the inbox and any other folders your guidance names for mail that is
        ...
        as empty.
    - id: apply-archive-rules
      prompt: |-
        Apply guidance/EMAIL.md's auto-archive rules **for real**. For each message
    ...
    - id: update-guidance
      prompt: |-
        Update guidance/EMAIL.md with anything durable this run taught you — a new
...
Triages your inbox and applies your guidance's auto-archive rules for real. The steps live in the frontmatter; this body is a human-facing description only.
